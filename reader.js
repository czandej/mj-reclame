    ...
    chapters: [
      ...
      },
      {
        ...
        content: [
          ...
          "Autor daje treść. System ma zadbać o sposób jej podania.",
...
function mapSubmissionToBook(item, index) {
  ...
  return {
    ...
    author: item.profiles?.username || "Autor MJ Reclame",
...
function renderLibrary(view = "library") {
  ...
  if (!books.length) {
    els.bookGrid.innerHTML = `<div class="author-publication-box"><strong>Nie ma jeszcze tekstów do czytania.</strong><p>Gdy autorzy opublikują zaakceptowane teksty, pojawią się tutaj jako biblioteka czytnika MJ Reclame.</p></div>`;
    return;
  }
